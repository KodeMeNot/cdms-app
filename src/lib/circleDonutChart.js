...
// Modified on:25/01/2021
// Modification: donut graph inner circle font color changed

export function circleDonutChart (chartElementID){
  let centerx = 0;
  let centery = 0;
  let sizex = 0;
  let sizey = 0;
  ...
  let innerCircleColor = "#666666";
  let outerCircleColor = "#aade87";
  let textColor = "#8c8ca3";
  let unitText = "%";
  let innerCircleDOM;
  let outerCircleDOM;
  let tNumberDOM;
