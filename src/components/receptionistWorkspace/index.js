...
import Courierworkspacemodal from "../../components/courierworkspacemodal";

const ReceptionistWorkspace = (props) => {
...
*/
  useEffect(async () => {
    let donutChartElement = document.querySelector("#donutChart");
    while (donutChartElement.firstChild) {
      donutChartElement.removeChild(donutChartElement.firstChild);
    }
    let barMarksChartElement = document.querySelector("#barMarksChart");
    ...
    let barMarkOptions = {
      ...
      legend: {
        ...
        customLegendItems: ['Total Enquiries'],
        markers: {
          fillColors: ['#00E396']
        }
      },
  ...
  function CustomerModalVisibility(e) {
    console.log('innnnnnnnnnnnnnnnnnnnnnnn', isVisitModalOpen);
    e.preventDefault();
    setVisitModalVisibility(true);
  }
  function closeVisitModal(e) {
    e.preventDefault();
    setVisitModalVisibility(false);
  }
  function CourierVisibility(e) {
    e.preventDefault();
    setCourierModalVisibility(true);
  }
  function CourierModalclose(e) {
    e.preventDefault();
    setCourierModalVisibility(!isCourierModalOpen);
  }
    ...
    <div>
      <div class="workspace-cards col-xs-12 col-sm-12 col-md-12 col-lg-12">
        <div class='row display-flex justify-between'>
          <div>
            <p class="fs-17">Reception Summary</p>
      ...
      <div class='row'>
        <div class='col-xs-12 col-sm-6 col-md-4 col-lg-3 m-t-20 p-l-0' >
          <div class="workspace-cards fadeMoveUpAnimation">
            <div class="row justify-between align-center">
              <div>
                <span class="fs-14 cursor-pointer" onClick={(e) => route('/workspacedetails/visitWorkspace')}>VISITS</span>
                <span class="workspace-cardsnumber fs-16 f-w-500 m-l-5">60</span>
              </div>
              <button class=" primary-border-button m-l-13" onClick={(e) => CustomerModalVisibility(e)} >VISIT &nbsp; +</button>
            </div>
              ...
              <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 p-0" >
                <div class="flex-sb borderteambottom p-b-8 p-t-8">
                  <div class="flex-sb">
                    ...
                    <span class="fs-14">Checked-In</span>
                  </div>
                ...
                <div class="flex-sb borderteambottom p-b-8 p-t-8">
                  <div class="flex-sb">
                    ...
                    <span class="fs-14">Checked-Out</span>
                  </div>
                  <span class="color-header-blue p-l-12 p-r-24 "><span class="fs-14">10</span></span>
                </div>
                <div class="flex-sb borderteambottom p-b-8 p-t-8">
        ...
        <div class='col-xs-12 col-sm-6 col-md-4 col-lg-3 m-t-20 p-l-0'>
          <div class="workspace-cards fadeMoveUpAnimation">
            <div class="row justify-between align-center">
              <div>
                <span class="fs-14">DELIVERIES</span>
        ...
        <div class='col-xs-12 col-sm-6 col-md-4 col-lg-3 m-t-20 p-l-0'>
          <div class="workspace-cards fadeMoveUpAnimation">
            <div class="row justify-between align-center">
              <div>
                <span class="fs-14 cursor-pointer" onClick={(e) => route('/workspacedetails/courierWorkspace')}>COURIER</span>
                <span class="workspace-cardsnumber fs-15 f-w-500 m-l-5">31</span>
              </div>
              <button class=" primary-border-button m-l-13" onClick={(e) => CourierVisibility(e)} >COURIER &nbsp; +</button>
            </div>
            <div class="row m-t-10">
              <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 p-0" >
                <div class="flex-sb borderteambottom p-b-8 p-t-8">
        ...
        <div class='col-xs-12 col-sm-6 col-md-4 col-lg-3 m-t-20 p-l-0 p-r-0'>
          <div class="workspace-cards fadeMoveUpAnimation">
            <div class="row justify-between align-center">
              <div>
                <span class="fs-14 cursor-pointer" title="Click to view Tasks" onClick={(e) => route('/workspacedetails/dayPlanWorkspace')}>Checklists</span>
                <span class="workspace-cardsnumber fs-15 f-w-500 m-l-5">50</span>
              </div>
              ...
              <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 p-0" >
                <div class="flex-sb borderteambottom p-b-8 p-t-8">
                  <div class="flex-sb">
                    ...
                    <span class="fs-14">Daily Tasks</span>
                  </div>
                  <span class="color-header-blue p-l-12 p-r-24 "><span class="fs-14">8</span></span>
                </div>
                <div class="flex-sb borderteambottom p-b-8 p-t-8">
                  <div class="flex-sb">
                    ...
                    <span class="fs-14">Display Car Checklists</span>
                  </div>
                  <span class="color-header-blue p-l-12 p-r-24 "><span class="fs-14">24</span></span>
                </div>
                <div class="flex-sb borderteambottom p-b-8 p-t-8">
                  <div class="flex-sb">
                    ...
                    <span class="fs-14">Test Drive Car Checklists</span>
                  </div>
                  <span class="color-header-blue p-l-12 p-r-24 "><span class="fs-14">18</span></span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class='col-xs-12 col-sm-6 col-md-4 col-lg-3 m-t-20 p-l-0 p-r-0'>
          <div class="workspace-cards fadeMoveUpAnimation">
            <div class="row justify-between align-center">
              <div>
                <span class="fs-14" onClick={(e) => route('/workspacedetails/displaycarsworkspace')}>FLEET</span>
                <span class="workspace-cardsnumber fs-15 f-w-500 m-l-5">50</span>
              </div>
              {/*<button class=" primary-border-button m-l-13" onClick={(e) => route('/displaycarsworkspace')} >VIEW FLEET</button>*/}
            </div>
      ...
      <div class="couriermodalslide">
        {
          isCourierModalOpen && (
            <Courierworkspacemodal open={isCourierModalOpen}  onClose={(e) => CourierModalclose(e)} />
          )
        }
      </div>
    </div>
